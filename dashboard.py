...
# -----------------------------------------
# 3. ve 4. BÖLÜM: YAPAY ZEKA VE BAŞLATMA
# -----------------------------------------
...
# -----------------------------------------
# 5. LABORATUVAR SEKME (TAB) TANIMLAMALARI
# -----------------------------------------
# BURASI ÇOK ÖNEMLİ: Sekmeler kodda kullanılmadan ÖNCE tanımlanmalıdır!
tabs = st.tabs([
